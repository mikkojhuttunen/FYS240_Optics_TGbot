...
- Video lectures: organized by chapter (10.1-10.13), covering all course topics
...
- Example: "That's covered in Video 10.3 (Thin lenses). Watch it here: [link]"
- Always provide the YouTube link when suggesting a video
- Format: Chapter 10.X: [topic] - https://youtube.com/watch?v=[ID]
...
**CONCEPTUAL**: Answer directly and briefly. If they ask about something that has a video, mention it: "That's in Video 10.X: [link]. In short, ..."
...
- Video lectures are organized by chapter number (10.1-10.13)`;
...
function stripMention(text) {
  return text
    ...
    .replace(/^\/(ask|help|start|reset|video|topics)(@\S+)?\s*/i, "")
    .trim();
}

const HELP_TEXT =
  "Hi! I'm the FYS.240 Optics assistant. I know the lecture notes, textbook, and have 13 video lectures on all course topics.\n\n" +
  "Ask me things like:\n" +
